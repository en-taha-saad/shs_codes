...
class PharmacistsFilters extends StatefulWidget {
  @override
  _FiltersState createState() => _FiltersState();
}

class _FiltersState extends State<PharmacistsFilters> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ExpansionTile(
        ...
        collapsedIconColor: generalColor6,
        iconColor: generalColor6,
