class Doctor {
  ...
  Doctor.fromJson(Map<String, dynamic> json) {
    ...
    patient = json['patient'] != null ? Patient?.fromJson(json['patient']) :
    null;
...
class Emails {
  ...
  Emails({this.id, this.email, this.doctorId,});
...
class Phones {
  ...
  Phones({this.id, this.phone, this.doctorId,});
...
class DoctorTitle {
  ...
  DoctorTitle.fromJson(Map<String, dynamic> json) {
    ...
    name = json['name'];
    extraInfo =
        json['extra_info'] != null ? ExtraInfoDoctor?.fromJson(json['extra_info']) : null;
  }
...
class Treatments {
  ...
  Treatments(
      {this.id, this.name, this.doctorId,});
...
class DoctorCertificates {
  ...
  DoctorCertificates.fromJson(Map<String, dynamic> json) {
    ...
    doctorId = json['doctor_id'];
    university =
    json['university'] != null ? University?.fromJson(json['university']) : null;
...
class University {
  ...
  static List<University> fromJsonList(List list) =>
      list.map((item) => University.fromJson(item)).toList();
}
...
class MedicalSpecialties {
  ...
  MedicalSpecialties.fromJson(Map<String, dynamic> json) {
    ...
    name = json['name'];
    extraInfo =
    json['extra_info'] != null ? ExtraInfoMedicalSpec?.fromJson(json['extra_info']) :
    null;
  }
...
class Memberships {
  ...
  Memberships.fromJson(Map<String, dynamic> json) {
    ...
    name = json['name'];
    extraInfo =
    json['extra_info'] != null ? ExtraInfoMemberShip?.fromJson(json['extra_info']) : null;
  }
