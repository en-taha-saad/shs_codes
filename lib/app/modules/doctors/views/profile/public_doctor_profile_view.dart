...
// import 'package:shs108private/app/modules/doctor_profile/universities_model.dart';

class PublicDoctorProfileView extends StatefulWidget {
  PublicDoctorProfileView({
    Key? key,
  }) : super(key: key);
  // final Doctor doctor;
  @override
  _PublicDoctorProfileViewState createState() =>
      _PublicDoctorProfileViewState();
}

class _PublicDoctorProfileViewState extends State<PublicDoctorProfileView> {
  ...
  Future<Doctor> fetechDoctorProfile() async {
    ...
    var request = http.Request(
      'GET',
      Uri.parse('$url/public_doctor_profile/${Get.arguments}'),
    );
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          doctor.medicalSpecialties!.isNotEmpty
                              ? Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
...
class PublicDoctorProfileView extends StatefulWidget {
  const PublicDoctorProfileView({Key? key}) : super(key: key);

  @override
  _PublicDoctorProfileViewState createState() => _PublicDoctorProfileViewState();
}
