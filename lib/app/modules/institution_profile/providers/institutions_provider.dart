...
Future<InstitutionsProfile>? getInstituions() async {
  days = [];
  profileImage = '';
  coverImage = '';
  isCover = false;
  isProfile = false;
  var headers = {
    // 'Authorization': 'Bearer 132|Zm7wKu3nLAnOgbw4vXN4DYGMHjQgyqcP7dxg8oL6',
    'Authorization': 'Bearer $savedToken',
    'Accept': 'application/json'
  };

  var request =
      http.Request('GET', Uri.parse('$url/private_institution/$institutionId'));
  ...
  if (response.statusCode == 200) {
    ...
    latitudeVar = dataMap.address?.location?.latitude;
    longitudeVar = dataMap.address?.location?.longitude;
