...
class SingleLab {
  ...
  SingleLab.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    about = json['about'];
    hasHormonesTests = json['has_hormones_tests'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['name'] = name;
    data['about'] = about;
    data['has_hormones_tests'] = hasHormonesTests;
