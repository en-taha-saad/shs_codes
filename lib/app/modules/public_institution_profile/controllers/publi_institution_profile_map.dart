...
class PublicProfileMarkersPage extends StatefulWidget {
  @override
  _PublicProfileMarkersPageState createState() => _PublicProfileMarkersPageState();
}

class _PublicProfileMarkersPageState extends State<PublicProfileMarkersPage> {
  MapController controller = MapController(
    location: LatLng(publiclatitudeVar!, publiclongitudeVar!),
  );
  final markers = [
    LatLng(publiclatitudeVar!, publiclongitudeVar!),
  ];
