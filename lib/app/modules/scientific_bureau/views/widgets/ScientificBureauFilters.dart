...
class ScientificBureauFilters extends StatefulWidget {
  @override
  _FiltersState createState() => _FiltersState();
}

class _FiltersState extends State<ScientificBureauFilters> {
  @override
          ...
          Column(
            ...
            children: <Widget>[
              ...
              DropDownFormFieldC(
                ...
                stringText: 'بحث حسب المكتب او الشركة',
              ...
              DropDownFormFieldC(
                  ...
                  stringText: 'بحث حسب المواد التجهيزية',
                  onChanged: (GetDataModel? model) {
                    print(model!.name);
                    print(model.id);
                    cityID = model.id;
