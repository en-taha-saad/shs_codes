...
class TherapeuticTrainingServicesFilters extends StatefulWidget {
  @override
  _FiltersState createState() => _FiltersState();
}

class _FiltersState extends State<TherapeuticTrainingServicesFilters> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ExpansionTile(
        ...
        collapsedIconColor: generalColor3,
        iconColor: generalColor3,
          ...
          Column(
            ...
            children: <Widget>[
              ...
              DropDownFormFieldC(
                  ...
                  stringText: 'بحث حسب البرنامج التدريبي',
